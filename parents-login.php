...
<head>
  ...
  <title><?= htmlspecialchars($system_title ?? 'Parent Login'); ?></title>
...
<div class="login-box">
  <div class="login-box-body">
    <div class="login-logo">
      <img src="main/images/gfaLogo.jpg" width="200" height="200" alt="School Logo">
    </div>

    <p class="login-box-msg">Parent Login</p>
    ...
    <form action="main/modal/user.php?do=loginparents" method="post" autocomplete="off">
